...
export default defineConfig({
  ...
  use: { baseURL: "http://127.0.0.1:5173", trace: "retain-on-failure", screenshot: "only-on-failure", video: "retain-on-failure", reducedMotion: "reduce", colorScheme: "light", deviceScaleFactor: 1 },
